...
|--------------------|--------------------|--------------|
| Desarrollo de una solución tecnológica funcional, centrada en el usuario y aplicando metodologías ágiles y herramientas de UX para entornos sin conectividad. | **Juan Carlos Angulo Abud:** <br><br> **Acciones TB1:** Desarrollé la arquitectura del sistema basada en dispositivos ESP32, integrando tecnologías de comunicación LoRa y Bluetooth para garantizar una solución funcional sin dependencia de internet. Implementé la conexión Bluetooth entre el dispositivo móvil y el ESP32, permitiendo la interacción con la aplicación. Asimismo, desarrollé la lógica de comunicación entre dispositivos mediante LoRa, asegurando la transmisión de datos a larga distancia en entornos rurales y escenarios de emergencia. Este trabajo incluyó la selección de tecnologías, pruebas de conectividad y validación del flujo de comunicación entre nodos. <br><br> **Renzo Paul Retuerto Zapata:** <br><br> **Acciones TB1:** Elaboré el análisis inicial del usuario mediante herramientas de experiencia de usuario como Empathy Maps, lo que permitió identificar comportamientos, pensamientos y necesidades clave. Redacté la introducción del proyecto, el Solution Profile y definí los segmentos objetivos, enfocándome en usuarios en zonas rurales y equipos de emergencia. Este proceso permitió comprender el contexto real del problema y establecer una base sólida para el desarrollo de la solución. <br><br> **Renzo Sebastián Uribe Livia:** <br><br> **Acciones TB1:** Apliqué la metodología Lean UX para definir el problema mediante el Problem Statement, identificar supuestos, formular hipótesis y desarrollar el Lean UX Canvas. Además, definí los User Personas y elaboré el AS-IS Scenario Mapping, lo que permitió entender la situación actual del usuario y sus limitaciones. Estas actividades ayudaron a validar la dirección del proyecto antes de su desarrollo técnico. <br><br> **Oscar Leonardo Espinoza Quijandria:** <br><br> **Acciones TB1:** Desarrollé la propuesta de solución mediante el To-Be Scenario Mapping, definiendo cómo el sistema resolverá los problemas identificados. Elaboré las User Stories con criterios de aceptación, construí el Impact Mapping alineando objetivos de negocio con comportamientos del usuario, y desarrollé el Product Backlog priorizado. Este trabajo permitió estructurar el desarrollo del sistema de forma organizada y orientada a valor. <br><br> **Stephano Mayrzon Landauri Preciado:** <br><br> **Acciones TB1:** Realicé entrevistas a usuarios en contextos relevantes, registré la información obtenida y desarrollé su análisis. Asimismo, elaboré una tabla de competidores para identificar soluciones existentes y oportunidades de mejora. Estas actividades permitieron validar la necesidad del sistema y reforzar la propuesta de valor del proyecto. | El equipo logró desarrollar una solución integral que combina investigación de usuario, diseño centrado en el usuario y desarrollo tecnológico. Se validó la viabilidad de una plataforma de comunicación sin internet basada en LoRa y Bluetooth, alineada a necesidades reales de usuarios en zonas rurales y escenarios de emergencia. Además, se estableció una estructura clara de desarrollo mediante metodologías ágiles, asegurando que cada componente del sistema tenga un propósito definido y un impacto directo en la solución del problema identificado. |
