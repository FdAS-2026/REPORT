...
| <img src="./images/foto5.png" width="100"><br>**Stephano Landauri Perciado** | Responsable del análisis de necesidades reales en entornos sin conectividad y alineación de la solución con los segmentos objetivo. |
