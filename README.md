...
| EP-05 | Almacenamiento local encriptado (SQLite) | Como developer del sistema, quiero implementar una base de datos local en SQLite encriptada, para almacenar mensajes, usuarios y configuraciones de forma segura sin depender de la nube. |
